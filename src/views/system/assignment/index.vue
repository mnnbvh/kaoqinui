<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="配电箱名称" prop="name">
        <el-input
      ...
      <el-form-item label="授权人名称" prop="personName">
        <el-input
      ...
      <el-form-item label="授权人id" prop="personNo">
        <el-input
          v-model="queryParams.personNo"
          placeholder="请输入授权人id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="授权部门" prop="department">
        <el-input
    ...
    <el-table v-loading="loading" :data="assignmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="配电箱名称" align="center" prop="name" />
      <el-table-column label="施工单位" align="center" prop="workUnit" />
      ...
      <el-table-column label="授权人名称" align="center" prop="personName" />
      <el-table-column label="授权人id" align="center" prop="personNo" />
      <el-table-column label="ic卡" align="center" prop="icCard" />
      <el-table-column label="授权部门" align="center" prop="department" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="配电箱名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入配电箱名称" />
        </el-form-item>
        <el-form-item label="施工单位" prop="workUnit">
          <el-input v-model="form.workUnit" placeholder="请输入施工单位" />
        </el-form-item>
        <el-form-item label="项目名称" prop="project">
        ...
        <el-form-item label="授权人名称" prop="personName">
          <el-input v-model="form.personName" placeholder="请输入授权人名称" />
        </el-form-item>
        <el-form-item label="授权人id" prop="personNo">
          <el-input v-model="form.personNo" placeholder="请输入授权人id" />
        </el-form-item>
        <el-form-item label="ic卡" prop="icCard">
          <el-input v-model="form.icCard" placeholder="请输入ic卡" />
        </el-form-item>
        <el-form-item label="授权部门" prop="department">
          <el-input v-model="form.department" placeholder="请输入授权部门" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除配电箱编号为"' + ids + '"的数据项？').then(function() {
